  ...
  return (
    <div className="landing-page bg-white text-gray-900">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center ">
            <div className="hero-content">
              ...
              <p className="text-xl mb-8 text-blue-100">
                Discover the smartest way to visit all your favorite spots in
                the city with our advanced route optimization technology.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="feature-card p-6 rounded-lg shadow-lg border border-gray-100 hover:border-blue-200 transition-all">
              <div className="feature-icon mb-4 w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center">
                <BoltIcon sx={{ fontSize: 32, color: '#1e3a8a' }} />
              </div>
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                Lightning-Fast Route Calculations
              </h3>
              <p className="text-gray-700">
                Our advanced algorithms find optimal routes in seconds, saving
                you hours of planning time.
              </p>
            </div>

            <div className="feature-card p-6 rounded-lg shadow-lg border border-gray-100 hover:border-blue-200 transition-all">
              <div className="feature-icon mb-4 w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center">
                <TuneIcon sx={{ fontSize: 32, color: '#1e3a8a' }} />
              </div>
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                Customizable Constraints
              </h3>
              <p className="text-gray-700">
                Set time limits, prioritize important locations, and choose your
            ...
            <div className="feature-card p-6 rounded-lg shadow-lg border border-gray-100 hover:border-blue-200 transition-all">
              <div className="feature-icon mb-4 w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center">
                <UpdateIcon sx={{ fontSize: 32, color: '#1e3a8a' }} />
              </div>
              <h3 className="text-xl font-bold mb-2 text-blue-900">
                Real-Time Updates
              </h3>
              <p className="text-gray-700">
                Get live traffic data and instant recalculations if your plans
                change during your journey.
              </p>
            </div>
          </div>
        </div>
            ...
            <table className="min-w-full bg-white rounded-lg overflow-hidden shadow-lg">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-blue-50 transition-colors">
                  <td className="px-6 py-4 font-medium">Bitonic TSP</td>
                  <td className="px-6 py-4">Shorter routes, Quick results</td>
                ...
                <tr className="hover:bg-blue-50 transition-colors">
                  <td className="px-6 py-4 font-medium">Nearest Neighbor</td>
                  <td className="px-6 py-4">
      ...
      <section className="cta-section py-20 px-8 bg-gradient-to-r from-blue-800 to-blue-900 text-white text-center">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
            Stop wasting time planning your routes. Let our advanced algorithms
            do the work for you.
          </p>
          <Link
            href={mapUrl}
      ...
      <footer className="footer-section py-8 px-8 bg-gray-100 text-center text-gray-600">
        <div className="container mx-auto max-w-6xl">
          <p>
            © {new Date().getFullYear()} WiseExplorer • All Rights Reserved
          </p>
        </div>
      </footer>
    </div>
