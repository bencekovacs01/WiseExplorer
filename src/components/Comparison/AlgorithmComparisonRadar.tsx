...
export const AlgorithmComparisonRadar: React.FC<ChartProps> = ({ data }) => {
  const normalizeData = (metric: string, value: number | undefined) => {
    ...
    if (
      ['executionTimeMs', 'memoryUsageMB', 'routeDistance'].includes(metric)
    ) {
  ...
  const radarData = [
    ...
    },
    {
      ...
      bitonicCW: normalizeData('memoryUsageMB', data.bitonicCW?.memoryUsageMB),
      bitonicCCW: normalizeData(
        'memoryUsageMB',
        data.bitonicCCW?.memoryUsageMB,
      ),
      bitonicIO: normalizeData('memoryUsageMB', data.bitonicIO?.memoryUsageMB),
      bitonicOI: normalizeData('memoryUsageMB', data.bitonicOI?.memoryUsageMB),
      branchAndBound: normalizeData(
        'memoryUsageMB',
      ...
      aroraPTAS: normalizeData('memoryUsageMB', data.aroraPTAS?.memoryUsageMB),
    },
    {
      ...
      bitonicCW: normalizeData('routeDistance', data.bitonicCW?.routeDistance),
      bitonicCCW: normalizeData(
        'routeDistance',
        data.bitonicCCW?.routeDistance,
      ),
      bitonicIO: normalizeData('routeDistance', data.bitonicIO?.routeDistance),
      bitonicOI: normalizeData('routeDistance', data.bitonicOI?.routeDistance),
      branchAndBound: normalizeData(
        'routeDistance',
      ...
      aroraPTAS: normalizeData('routeDistance', data.aroraPTAS?.routeDistance),
    },
  ];
