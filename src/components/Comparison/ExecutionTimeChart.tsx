...
export const ExecutionTimeChart: React.FC<ChartProps> = ({ data }) => {
  ...
  const durationData = Object.entries(data)
    ...
    .map(([key, value]) => {
      ...
      return {
        name,
        distance:
          value?.routeTotalTime || value?.totalTime || value?.routeDuration,
      };
    });
  ...
  return (
    ...
    >
      ...
      >
        <Typography variant="subtitle2">Execution Time Comparison</Typography>
      ...
      >
        <Typography variant="subtitle2">Route Distance Comparison</Typography>
      ...
      >
        <Typography variant="subtitle2">Route Duration Comparison</Typography>
